...
pipeline_config = {
    ...
    'lr_step': 5e-1,
    'milestones': [10, 20, 30, 40, 50, 70, 100],
    # 'total_epoch': tune.grid_search[200,400,1000],
    # Train epoch and eval_epoch to use
    "train_epoch": train_epoch,
    "eval_epoch": eval_epoch,
    "wandb_group": 'compare cell-transfer tissue based  on DrugComb for with and without cell features'
}
...
configuration = {
    ...
    "memory": 1800,
    "stop": {"training_iteration": 500, 'patience': 5},
