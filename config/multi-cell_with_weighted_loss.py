...
from models import MyBaseline, WeightedRegression
...
pipeline_config = {
    ...
    "wandb_group": 'multi-cell with dropout and with and without weighted loss'
}
...
model_config = {
    "model": tune.grid_search([WeightedRegression,MyBaseline]),
    "load_model_weights": False,
}

dataset_config = {
    "dataset": tune.grid_search([DrugCombForDataAnalysisHQ,DrugCombForDataAnalysis]),
