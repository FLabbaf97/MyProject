...
from datasets.drugcomb_matrix_data import DrugCombMatrix, DrugCombMatrixWithAE, DrugCombMatrixWithAE_offQFilter, DrugCombMatrixWithAE_MQFilter
import sys
import os
...
pipeline_config = {
    ...
    "wandb_group": 'cell-transfer liagand-based drugComb'
}
...
dataset_config = {
    "dataset": tune.grid_search([DrugCombMatrixWithAE, DrugCombMatrixWithAE_offQFilter, DrugCombMatrixWithAE_MQFilter]),
    "study_name": '',
    ...
    "cell_line": tune.grid_search([Breast, Lung, Skin, Blood]),   # 'PC-3',
